...
/* NCC-1701 Enterprise easter egg for Star Trek Day (Sep 8)
 */

#define ENT_C           BRGRAY          // Enterprise colour - light grey

#define ENT_W 17
#define ENT_H 50
static const uint8_t enterprise[ENT_W*ENT_H] PROGMEM = {
 ,
};

#define ENT_WPIX        (ENT_W*8)
#define ENT_HPIX        (ENT_H)

SBox ent_b = {0, 0, ENT_WPIX, ENT_HPIX};

static void drawEntBox(void)
{
    for (uint16_t sr = 0; sr < ENT_HPIX; sr++) {
        for (uint16_t sc = 0; sc < ENT_W; sc++) {
            uint16_t mask = pgm_read_byte(&enterprise[sr*ENT_W+sc]);
            for (uint16_t bc = 0; bc < 8; bc++) {
                uint16_t sx = tft.SCALESZ*ent_b.x + 8*sc + bc;
                uint16_t sy = tft.SCALESZ*ent_b.y + sr;
                if (mask & (1<<bc))
                    tft.drawPixelRaw (sx, sy, ENT_C);
            }
        }
    }
}

static void eraseEntBox(const SBox &s)
{
#if defined(_IS_ESP8266)
    for (uint16_t sr = 0; sr < ENT_HPIX; sr++) {
        for (uint16_t sc = 0; sc < ENT_W; sc++) {
...
/* draw Enterprise on Star Trek Day (Sep 8)
 */
void drawEnterprise()
{
    time_t t = nowWO() + getTZ (de_tz);
    if (month(t) != 9 || day(t) != 8) {
        ent_b.x = ent_b.y = 0;
        return;
    }
    float hr_frac = hour(t)/23.0F;
    ...
    case MAPP_MERCATOR: {
        uint16_t y_t = map_b.y + 1;
        uint16_t y_b = map_b.y + map_b.h - ENT_HPIX - 1;
        ent_b.y = y_t + hr_frac*(y_b-y_t);
        uint16_t x_l = map_b.x + 1;
        uint16_t x_r = map_b.x + map_b.w - ENT_WPIX - 1;
        ent_b.x = x_l + mn_frac*(x_r-x_l);
        } break;
    case MAPP_ROB: {
        uint16_t tb_border = ENT_HPIX/2;
        uint16_t y_t = map_b.y + tb_border;
        uint16_t y_b = map_b.y + map_b.h - tb_border - ENT_HPIX;
        ent_b.y = y_t + hr_frac*(y_b-y_t);
        uint16_t y_hw;
        if (ent_b.y < yc-ENT_HPIX/2)
            y_hw = hw * RobLat2G (90*(yc - ent_b.y)/hh);
        else
            y_hw = hw * RobLat2G (90*(yc - ent_b.y - ENT_HPIX)/hh);
        uint16_t x_l = xc - y_hw;
        uint16_t x_r = xc + y_hw - ENT_WPIX;
        ent_b.x = x_l + mn_frac*(x_r-x_l);
        } break;
    case MAPP_AZIMUTHAL: {
        uint16_t tb_border = ENT_HPIX/2;
        ...
        float y_frac;
        if (ent_b.y < yc-ENT_HPIX/2)
            y_frac = (yc - ent_b.y)/(float)hh;
        else
            y_frac = (ent_b.y + ENT_HPIX - yc)/(float)hh;
        uint16_t ew = hh * sqrtf(1 - y_frac*y_frac);
        uint16_t x_l, x_r;
        if (mn_frac < 0.5F) {
            x_l = xc - hh - ew; x_r = xc - hh + ew - ENT_WPIX;
            ent_b.x = x_l + 2*mn_frac*(x_r-x_l);
        } else {
            x_l = xc + hh - ew; x_r = xc + hh + ew - ENT_WPIX;
            ent_b.x = x_l + 2*(mn_frac-0.5F)*(x_r-x_l);
        }
        } break;
    case MAPP_AZIM1: {
        uint16_t tb_border = ENT_HPIX/2;
        ...
        if (ent_b.y < yc-ENT_HPIX/2)
            ...
            y_frac = (ent_b.y + ENT_HPIX - yc)/(float)hh;
        uint16_t ew = hw/2 * sqrtf(1 - y_frac*y_frac);
        uint16_t x_l = xc - ew;
        uint16_t x_r = xc + ew - ENT_WPIX;
        ent_b.x = x_l + mn_frac*(x_r-x_l);
        } break;
    default:
        fatalError ("drawEnterprise() map_proj %d", map_proj);
    }
    if (s0.x && (ent_b.x != s0.x || ent_b.y != s0.y))
        eraseEntBox (s0);
    if (overMap (ent_b))
        drawEntBox();
    else
